// [BASELINE] lib/features/pro/widgets/recall_card.dart (Stand: 2025-11-07)
// Pro Widgets — RecallCard (v1.0.0)
//
// Zweck
// ------
// Zeigt eine sanfte „Rückblick“-Karte mit optionaler Mini-Sparkline (Trend) und
// einem kurzen Rückblickstext. Die Copy kommt idealerweise aus
// MemoryService.buildRecallSummary(...).
//
// Verwendung
// ----------
// RecallCard(
//   series14: series.takeLast(14),              // −2..+2; optional für Mini-Trend
//   initialSummary: cachedText,                 // optional
//   loadRecallSummary: () => MemoryService
//       .instance.buildRecallSummary(),         // optional async Loader
//   onTap: () => openDetailsSheet(),            // optional
// )
//
// Design
// ------
// Oxford-Zen: dezentes Glas-Panel, tiefe Sage-Typografie, viel Luft.
// Kein Coaching-Ton, nur ruhiger Rückblick.
// A11y: Semantics für Titel, Text und Trend.
//
...
class RecallCard extends StatefulWidget {
  /// Optionaler 14-Tage-Trend (Werte −2..+2). Wenn null/leer, wird kein Trend angezeigt.
...
class _RecallCardState extends State<RecallCard> {
  ...
  Future<void> _fetch() async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() => _summary = (s?.trim().isEmpty ?? true) ? null : s!.trim());
    } catch (_) {
      if (!mounted) return;
      // still, stay silent; we show a neutral placeholder
    } finally {
            ...
            child: zw.ZenGlassCard(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Inhalt / Copy
                  if (_loading) const _SummarySkeleton()
